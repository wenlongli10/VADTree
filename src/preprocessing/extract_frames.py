...
def parse_args():
    ...
    parser.add_argument(
        "--videos_dir",
        type=str,
        default="/root/autodl-tmp/SegAnyMo/result/UCF_Crime_test/test_videos",
    ...
    parser.add_argument(
        "--frames_dir",
        type=str,
        default="/root/autodl-tmp/SegAnyMo/result/UCF_Crime_test/test_videos/images",
    ...
    parser.add_argument(
        "--annotations_file",
        type=str,
        default="/root/autodl-tmp/data/LAVAD_data/ucf_crime/annotations/anomaly_test.txt",
        # required=True,
